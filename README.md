...
| tissue_mask  | Tissue mask image, tif format                                | Required     | string        | [saw](https://github.com/STOmics/SAW) outputs files (`<SN>_<staintype>_tissue_cut.tif`), [details](https://stereotoolss-organization.gitbook.io/saw-user-manual-v8.2/analysis/outputs/count-outputs) |
| record_sheet | Obtained from the experimental side, records slice positions, correspondence between preceding and subsequent slices | Required     | string        | We have provided you with an [example](https://docs/E-ST20220923002_slice_records_20221110.xlsx). Click to view [details](https://docs/extra.md). |
